...
import { Shield, Clock, Phone, Key, FileCheck, Users, TrendingUp, Award, Download, Handshake } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 opacity-95">
              We protect your clients (and your reputation) with thorough, balanced inspections
              that inform without alarming. Fast reports, clear communication, smooth closings.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-mediumGray max-w-3xl mx-auto">
              We understand that your reputation is on the line with every referral.
              That's why we treat every inspection as an opportunity to strengthen your client relationships.
            </p>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-xl text-charcoal mb-2">
                      To always act as a professional, courteous, and knowledgeable extension of your team
                    </h3>
                    <p className="text-mediumGray">
                      We understand we're representing you. Every interaction reflects on your professionalism.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-xl text-charcoal mb-2">
                      To provide clear, objective, and timely information that empowers your clients
                    </h3>
                    <p className="text-mediumGray">
                      No surprises, no confusion. Just the facts your clients need to make informed decisions.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-xl text-charcoal mb-2">
                      To be readily available for you and your clients to answer any questions after the inspection
                    </h3>
                    <p className="text-mediumGray">
                      Our service doesn't end with the report. We're here through negotiations and closing.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="bg-lightGray rounded-lg p-6 text-center">
              ...
              <h3 className="font-bold text-xl text-charcoal mb-2">Co-Branded Materials</h3>
            ...
            <div className="bg-lightGray rounded-lg p-6 text-center">
              ...
              <h3 className="font-bold text-xl text-charcoal mb-2">"What to Expect" Guide</h3>
              <p className="text-mediumGray mb-4">
            ...
            <div className="bg-lightGray rounded-lg p-6 text-center">
              ...
              <h3 className="font-bold text-xl text-charcoal mb-2">Preferred Agent Portal</h3>
              <p className="text-mediumGray mb-4">
      ...
      <section className="py-16 bg-primaryBlue text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-95 max-w-2xl mx-auto">
            Add us to your preferred inspector list and experience the difference a true partner makes.
