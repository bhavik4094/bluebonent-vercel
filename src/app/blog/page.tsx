...
import { Calendar, Clock, ChevronRight, TrendingUp, Shield, AlertTriangle, Users, FileQuestion } from "lucide-react";
...
const blogPosts: BlogPost[] = [
  {
    ...
    title: "Who's Really Inspecting Your Home? Why Corporate Companies Send Rookies to Your Biggest Investment",
    excerpt: "Reveals how franchise business models often result in inexperienced inspectors handling major purchases. Contrasts corporate \"whoever's available\" approach with owner-operator accountability and expertise.",
  ...
  },
  {
    ...
    title: "The $500 Liability Trap: How Corporate Inspectors Escape Responsibility for $50,000 Mistakes",
    excerpt: "Exposes the fine print in inspection contracts that limits liability to just the inspection fee, leaving homebuyers with virtually no recourse when catastrophic issues are missed.",
  ...
  },
  {
    ...
    title: "10 Questions That Will Reveal if Your Inspector Works for You or Your Realtor",
    excerpt: "A tactical guide with specific questions designed to expose conflicts of interest, lack of experience, and liability dodging before you hire an inspector.",
  ...
  },
  {
    ...
    excerpt: "Tim's personal story about choosing integrity over easy referrals, and why thorough inspections that protect buyers are more important than keeping agents happy.",
  ...
  },
  {
    ...
    excerpt: "How standard inspection practices allow testing only a fraction of outlets and windows, potentially missing serious defects that remain 'compliant' with industry standards.",
  ...
  },
  {
    ...
    title: "What 'Visual Only' Really Means (And What's Hiding Behind Your Walls)",
    excerpt: "Explains the shocking limitations of standard inspections and why specialized testing for mold, asbestos, and sewer lines isn't just optional—it's essential.",
    category: "Education",
    readTime: "6 min read",
    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-lightGray">
      ...
      <section className="py-20 bg-gradient-to-r from-charcoal to-black text-white">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-4xl">
            <div className="inline-block px-4 py-2 bg-yellow-500 text-black font-bold text-sm rounded-full mb-6">
              INDUSTRY TRUTH-TELLER
            </div>
            <h1 className="font-serif text-5xl lg:text-7xl font-bold mb-6">
              The Blog Big Inspection
              <span className="text-yellow-400"> Doesn't Want You to Read</span>
            </h1>
            <p className="text-xl opacity-90 mb-8">
              Exposing industry secrets, protecting Cedar Park families, and teaching you what corporate
              inspectors hope you never learn about your biggest investment.
            </p>
      ...
      {featuredPost && (
        <section className="py-16 bg-white">
          <div className="container mx-auto px-6 lg:px-12">
            <div className="mb-8">
              <h2 className="font-serif text-3xl font-bold text-charcoal">Featured Investigation</h2>
            </div>
            <a
              href={featuredPost.comingSoon ? "#" : `/blog/${featuredPost.slug}`}
                ...
                <div className="p-8 lg:p-12">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="flex justify-center lg:justify-start">
                      <div className={`w-32 h-32 rounded-2xl bg-gradient-to-br ${featuredPost.gradient} flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform duration-500`}>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-mediumGray max-w-3xl mx-auto">
              Every article arms you with knowledge the inspection industry doesn't want you to have.
              Because an educated buyer is a protected buyer.
            </p>
          </div>
                  ...
                  <div className="h-full bg-white rounded-xl shadow-elegant hover:shadow-3d-hover transition-all duration-500 overflow-hidden">
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        <div className={`p-3 rounded-lg bg-gradient-to-br ${post.gradient} bg-opacity-10`}>
                        ...
                        <div className="flex-1">
                          <div className="flex flex-wrap gap-2 mb-2">
                            ...
                            {post.comingSoon && (
                              <span className="text-xs px-2 py-0.5 bg-yellow-100 text-yellow-700 font-bold rounded-full">
                                Soon
                              </span>
                            )}
                          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primaryBlue ">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl opacity-90 mb-8">
              Get industry exposés, buyer protection tips, and inspection insights delivered to your inbox.
              Knowledge is your best defense against a bad inspection.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
              <input
                ...
                disabled
              />
              <button className="px-8 py-3 bg-yellow-400 text-charcoal font-bold rounded-full hover:bg-yellow-500 transition-colors" disabled>
                Coming Soon
              </button>
            </div>
