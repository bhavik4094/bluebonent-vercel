...
export const metadata: Metadata = {
  ...
  description:
    "Trusted home inspections in Cedar Park, TX. Tim McCoy personally inspects every home with 10+ years experience. Schedule your inspection today. 512-560-5670",
  keywords:
    "home inspector, Cedar Park, Texas, home inspection, TREC licensed, Tim McCoy, property inspection",
  openGraph: {
    title: "Bluebonnet Home Inspections - Cedar Park's Most Trusted Inspector",
    description:
      "Protecting Cedar Park families with thorough, honest home inspections since 2010",
