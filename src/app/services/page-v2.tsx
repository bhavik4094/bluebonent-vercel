        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base text-gray-600 mb-10 max-w-xl mx-auto leading-relaxed font-light">
              Every home inspection handled with exceptional care for your family's safety.
              Safe even for babies, pets, and those with allergies. Zero compromises.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-base mb-1.5">Family Starter Pack</h3>
              <p className="text-xs text-gray-500 mb-3 leading-relaxed px-2">Complete 400-point inspection for families and first-time buyers</p>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-base mb-1.5">Cleaner Starter Packs</h3>
              <p className="text-xs text-gray-500 mb-3 leading-relaxed px-2">Pre-listing inspection to sell faster and for more money</p>
              <button className="bg-gray-900 text-white text-[11px] font-semibold tracking-wider px-5 py-2 rounded-full hover:bg-gray-800 transition-all uppercase">
                Shop Now
              </button>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-base mb-1.5">Concentrate Refills</h3>
              <p className="text-xs text-gray-500 mb-3 leading-relaxed px-2">New construction verification and phase inspections</p>
              <button className="bg-gray-900 text-white text-[11px] font-semibold tracking-wider px-5 py-2 rounded-full hover:bg-gray-800 transition-all uppercase">
                Shop Now
              </button>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mb-3 leading-relaxed px-2">Investment property analysis with ROI projections</p>
              <button className="bg-gray-900 text-white text-[11px] font-semibold tracking-wider px-5 py-2 rounded-full hover:bg-gray-800 transition-all uppercase">
                Shop Now
              </button>
            </div>
            ...
            <table className="w-full text-sm">
                ...
                <tr className="border-b border-gray-100">
                  ...
                  <th className="text-center p-5">
                    <div className="inline-block">
                      <p className="font-bold text-base text-mint-600">100% Tim-<br/>Based</p>
                      <p className="text-xs text-gray-400 mt-1">Bluebonnet</p>
                    </div>
                  </th>
                  <th className="text-center p-5">
                    <div className="inline-block">
                      <p className="font-bold text-base text-gray-600">Competitor<br/>2020</p>
                      <p className="text-xs text-gray-400 mt-1">Chain Inspectors</p>
                    </div>
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-100 hover:bg-gray-50/50">
                  <td className="p-5 text-gray-600">Owner Performs Every Inspection</td>
                  <td className="text-center p-5"><CheckIcon className="inline text-mint-500" size={20} /></td>
                  <td className="text-center p-5"><span className="text-red-400 text-xl font-light">×</span></td>
                </tr>
                <tr className="border-b border-gray-100 hover:bg-gray-50/50">
                ...
                <tr className="border-b border-gray-100 hover:bg-gray-50/50">
                  <td className="p-5 text-gray-600">Same-Day Digital Reports</td>
                  <td className="text-center p-5"><CheckIcon className="inline text-mint-500" size={20} /></td>
                  <td className="text-center p-5"><span className="text-red-400 text-xl font-light">×</span></td>
                </tr>
                <tr className="border-b border-gray-100 hover:bg-gray-50/50">
                  <td className="p-5 text-gray-600">Direct Cell Phone Access</td>
                  <td className="text-center p-5"><CheckIcon className="inline text-mint-500" size={20} /></td>
                  <td className="text-center p-5"><span className="text-red-400 text-xl font-light">×</span></td>
                </tr>
                <tr className="border-b border-gray-100 hover:bg-gray-50/50">
                  <td className="p-5 text-gray-600">Free Thermal Imaging Included</td>
                  <td className="text-center p-5"><CheckIcon className="inline text-mint-500" size={20} /></td>
                  <td className="text-center p-5"><span className="text-red-400 text-xl font-light">×</span></td>
                </tr>
                <tr className="hover:bg-gray-50/50">
                  <td className="p-5 text-gray-600">200% Satisfaction Guarantee</td>
                  <td className="text-center p-5"><CheckIcon className="inline text-mint-500" size={20} /></td>
                  <td className="text-center p-5"><span className="text-red-400 text-xl font-light">×</span></td>
                </tr>
              </tbody>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-gray-500 text-sm mb-10 max-w-2xl mx-auto">
              Years ago, Tim decided to bring a new standard to home inspections - one that puts families first.
              Every inspection personally performed, every detail carefully documented, every client personally cared for.
            </p>
            ...
            <div className="bg-mint-50/30 rounded-xl p-8 mb-10">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                A home inspection service that families trust completely. With 1,500+ inspections performed,
                a perfect 5-star rating, and zero compromises on quality, we've proven that doing things right
                matters. Every inspection gets Tim's personal attention, from the initial phone call to the
                final report and beyond.
              </p>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center py-3">
                  <p className="text-3xl font-bold text-mint-600">1,500+</p>
                  <p className="text-xs text-gray-500 mt-1">Inspections Completed</p>
                </div>
                <div className="text-center py-3">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
              A better way to inspect - for families and investors. Every detail matters when
              protecting your biggest investment. That's why Tim personally performs every inspection,
              provides direct cell phone access, and stands behind every report.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="bg-white rounded-xl p-6 border border-gray-100">
              ...
              <p className="text-sm text-gray-600 mb-3 leading-relaxed">
                "Tim's inspection saved us from a $50,000 foundation problem. Worth every penny!"
              </p>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-100">
              ...
              <p className="text-sm text-gray-600 mb-3 leading-relaxed">
                "100% thorough service - tough on problems, gentle with clients. Highly recommend!"
              </p>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-100">
              ...
              <p className="text-sm text-gray-600 mb-3 leading-relaxed">
                "Tim treated our home like it was his own. Found 47 issues in our 'perfect' new build."
              </p>
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xs text-gray-400">
            or call <a href="tel:512-560-5670" className="text-white underline">512-560-5670</a>
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            We bring cutting-edge technology and proven methods to every inspection
          </p>
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-sm mb-2 uppercase tracking-wider">Safe Surfactants</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-sm mb-2 uppercase tracking-wider">Careful Processing</h3>
              <p className="text-xs text-gray-500 leading-relaxed px-4">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-sm mb-2 uppercase tracking-wider">Exceptional Hygiene</h3>
              <p className="text-xs text-gray-500 leading-relaxed px-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-12 max-w-3xl mx-auto">
            <div className="text-center">
              <div className="w-20 h-20 mx-auto mb-4">
                <svg className="w-full h-full" viewBox="0 0 80 80" fill="none">
                  <circle cx="40" cy="40" r="38" stroke="#86efac" strokeWidth="2"/>
                  <path d="M40 15v25M40 40l15 15" stroke="#22c55e" strokeWidth="3" strokeLinecap="round"/>
                </svg>
              </div>
              <h3 className="font-semibold text-sm mb-2 uppercase tracking-wider">Water</h3>
            ...
            <div className="text-center">
              <div className="w-20 h-20 mx-auto mb-4">
                <svg className="w-full h-full" viewBox="0 0 80 80" fill="none">
                  <rect x="20" y="20" width="40" height="40" rx="8" stroke="#a5b4fc" strokeWidth="2"/>
                  <circle cx="40" cy="40" r="8" fill="#6366f1"/>
                </svg>
              </div>
              <h3 className="font-semibold text-sm mb-2 uppercase tracking-wider">Alkyl Glycosides</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <div className="text-center">
              <div className="w-20 h-20 mx-auto mb-4">
                <svg className="w-full h-full" viewBox="0 0 80 80" fill="none">
                  <path d="M40 10l10 20 20 3-15 14 4 20L40 55 21 67l4-20L10 33l20-3z" stroke="#fbbf24" strokeWidth="2" fill="#fef3c7"/>
                </svg>
              </div>
              <h3 className="font-semibold text-sm mb-2 uppercase tracking-wider">Ethanol</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-base text-gray-600 mb-6 leading-relaxed">
                Our inspection process is completely non-invasive and safe for your property.
                Using advanced technology like thermal imaging and proven inspection methods,
                we deliver thorough evaluations without any damage.
              </p>
              <button className="bg-gray-900 text-white text-xs font-semibold tracking-widest px-7 py-3.5 rounded-full hover:bg-gray-800 transition-all uppercase">
                Shop Now
              </button>
            ...
            <div className="relative">
              <div className="bg-mint-50 rounded-2xl p-8 text-center">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Non-invasive methods mean zero damage to your property.
                  Every inspection uses the same care we'd give our own home.
                </p>
